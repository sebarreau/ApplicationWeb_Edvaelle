package ht.mbds.barreausachyedvalle.applicationweb_3.jsf;

import ht.mbds.barreausachyedvalle.applicationweb_3.llm.LlmClient;
...
public class Bb implements Serializable {
    ...
    public String envoyer() {
        ...
        this.reponse = llmClient.envoyerQuestion(roleSystemePourModification, this.question);
